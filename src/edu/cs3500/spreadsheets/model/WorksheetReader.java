...
public final class WorksheetReader {
  ...
  public interface WorksheetBuilder<T> {
     ...
     */
    WorksheetModel createWorksheet();

    /**
     * Adds a graph to the worksheet.
     * @param name the name of the graph.
     * @param contents the contents of a worksheet.
     */
    WorksheetBuilder<T> addGraph(String name, String contents);
  }
   ...
   * @return the fully-filled-in Worksheet
   */
  public static <T> WorksheetModel read(WorksheetBuilder<T> builder, Readable readable) {
    ...
    while (scan.hasNext()) {
      ...
      // Update the reader to store bar graphs
      if (cell.equals("BAR")) {
        String contents = scan.nextLine();
        builder = builder.addGraph("BAR", contents);
      }
